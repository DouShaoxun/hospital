...
/**
 * @Classname: BeetlSqlGen
 * @Author: Dsx
 * @Date: 2020/07/15/21:33
 */
...
public class BeetlSqlGen {
    ...
    // ========生成实体类所在的包=========
    private static String pojoPkg = "cn.dsx.hospital.entity";
    // ========生成mapper类所在的包=========
    private static String mapperPkg = "cn.dsx.hospital.dao";
